...
The module utilizes [nestedSortable](https://web.archive.org/web/20110307084758/http://mjsarfatti.com/sandbox/nestedSortable/) jQuery plugin for drag-drop sorting of menu items in backend.  
Free CSS dropdown menu from [http://www.lwis.net/free-css-drop-down-menu/](https://web.archive.org/web/20110714022205/http://www.lwis.net/free-css-drop-down-menu/) is used for menu styles and themes.

The code for menu rendering is borrowed from [emenu](http://www.yiiframework.com/extension/emenu) extension.  
The code for implementing nestedSortable is borrowed from the dead project at [http://code.google.com/p/at-menu](https://web.archive.org/web/20110419083918/https://code.google.com/p/at-menu)

## Installation

Download from <https://github.com/isDipesh/yii-menu/zipball/master>
